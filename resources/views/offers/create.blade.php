                ...
                <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="Percantage" class="form-control" id="exampleInputPercantage" placeholder="Enter Percantage">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputCount">Count <span style="color: red;">*</span></label>
                      <input type="text" name="Count" class="form-control" id="exampleInputCount" placeholder="Enter Count">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="Servicename" class="form-control" id="exampleInputServicename" placeholder="Enter Servicename">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
