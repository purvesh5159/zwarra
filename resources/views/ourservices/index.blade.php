    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="poppins-semibold zw_46 zw_text_AF2245 mt-3">Our Services</h1>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content-header">
        <div class="row mb-2">
          ...
          <div class="col-6">
            <a class="btn zw_add_btn float-right  poppins-medium zw_18" href="{{ route('ourservices.create') }}"> <i class="fas fa-plus right mr-2"></i>Add new main service</a>
