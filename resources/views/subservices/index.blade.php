    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="poppins-semibold zw_46 zw_text_AF2245 mt-3">Our Sub Services</h1>
            </div>
            <!-- <div class="col-sm-6">
              <h1>Our Sub Services</h1>
            </div> -->
            <div class="col-sm-6">
              <a class="btn zw_add_btn float-right  poppins-medium zw_18" href="{{ route('subservices.create') }}"> <i class="fas fa-plus right mr-2"></i>Add new sub service</a>
                    ...
                    <tr>
                      ...
                      <td class="poppins-regular zw_14 zw_text_333333">
                        <form action="{{ route('subservices.destroy',$subservice->id) }}" method="POST">
                          <a class="btn zw_btn" href="{{ route('subservices.show',$subservice->id) }}">Show</a>
                          @csrf
                          @method('DELETE')
