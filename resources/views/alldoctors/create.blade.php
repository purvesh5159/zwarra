                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="exampleInputlogo">Upload Image</label>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="Licenceno" class="form-control" id="exampleInputLicenceno" placeholder="Enter licence number">
                    </div>
                    <div class="form-group col-md-6">
